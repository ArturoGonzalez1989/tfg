...
<div class="container my-5 p-5 border">
    <div class="row">
        <div class="col-md-9">
        	...
        	<p>Última modificación: {{ $usuario->updated_at }}</p>
			<a class="btn btn-primary" href="{{ route('usuarios.edit', $usuario->id) }}">Editar usuario</a>
        </div>
        <div class="col-md-3">
    ...
    <div class="card-header" id="headingOne">
      <h5 class="mb-0">
        <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          Rutas creadas por {{ $usuario->nombre }}
        </button>
      </h5>
    </div>
